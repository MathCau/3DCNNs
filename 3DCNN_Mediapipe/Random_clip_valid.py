        ...
        with self.graph.as_default():
            ...
            with tf.Session(config=config, graph=self.graph) as sess:
                ...
                for one_epoch in range(40):
                    ...
                    total_v = 0.0
                    test_correct_num = 0
                    for i in tqdm(range(int(620 / self.batch_size))):
                        step += 1
                        ...
                        print('test acc:', test_correct_num / total_v, 'test_correct_num:', test_correct_num,
                              'total_v:', total_v)
                    clip_val_data=[one_epoch, test_correct_num / total_v]
                    with open('clip_random_data.csv', 'a', newline='') as f:
                            writer = csv.writer(f)
                            writer.writerow(clip_val_data)
